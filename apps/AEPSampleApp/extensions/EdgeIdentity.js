...
function getIdentities() {
  ...
  var authenticatedState1 = AEPAuthenticatedState.AUTHENTICATED;
  var isPrimary1 = true;

  var identifier2 = "id2";
  var namespace2 = "2ndNameSpace"
  var authenticatedState2 = AEPAuthenticatedState.LOGGEDOUT;
  ...
  AEPIdentity.getIdentities().then(identities => console.log("AdobeExperienceSDK: Get AEPIdentity Maps = " + identities));
}

 //     AEPIdentity.getIdentities().then(function(identities) {
 //      console.log("AdobeExperienceSDK: Get AEPIdentity Maps = " + typeof identities  + "    " + JSON.stringify(identities));
 //      identities.addItem(identityItems1, namespace1);
 //      console.log("AdobeExperienceSDK: Get AEPIdentity Maps = " + typeof identities  + "    " + JSON.stringify(identities));
 //    });
 // }
